...
public class Art extends JPanel{
	...
	public Art(){
		...
		img = new ImageIcon("./toilet/2_art.png");
		...
		fb1p = new JLabel("B162 창고 옆");
		fb1p.setFont(position);
		
		f1p = new JLabel("왼쪽 계단실 앞");
		...
		toiletinfo.add(Box.createHorizontalStrut(60));
	...
	public void paint(Graphics g) {
		...
		g2d.fillOval(300, 300, 15, 15);

		g2d.setColor(Color.BLUE);
		g2d.fillOval(185, 450, 15, 15);

		g2d.setColor(Color.BLUE);
		g2d.fillOval(215, 450, 15, 15);

		g2d.setColor(Color.BLACK);
		g2d.fillOval(60, 160, 10, 10);

		g2d.setColor(Color.BLUE);
		g2d.fillOval(60, 185, 10, 10);
