...
public class Student extends JPanel{
	...
	ImageIcon img;
	JLabel image, t1, f1, f1p, f2, f2p, f7, f7p;
	...
	public Student(){
		...
		img = new ImageIcon("./toilet/1_student.png");
		...
		toiletinfo.add(Box.createHorizontalStrut(70));
	...
	public void paint(Graphics g) {
		...
		g2d.fillOval(495, 360, 15, 15);

		g2d.setColor(Color.BLUE);
		g2d.fillOval(230, 200, 15, 15);
