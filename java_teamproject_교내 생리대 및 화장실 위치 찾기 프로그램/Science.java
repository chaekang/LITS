...
public class Science extends JPanel{
	...
	public Science(){
		...
		img = new ImageIcon("./toilet/2_science.png");
	...
	public void paint(Graphics g) {
		...
		g2d.fillOval(323, 330, 15, 15);

		g2d.setColor(Color.BLUE);
		g2d.fillOval(340, 390, 15, 15);

		g2d.setColor(Color.BLUE);
		g2d.fillOval(362, 390, 15, 15);

		g2d.setColor(Color.BLUE);
		g2d.fillOval(88, 400, 15, 15);

		g2d.setColor(Color.BLUE);
		g2d.fillOval(73, 440, 15, 15);

		g2d.setColor(Color.BLACK);
		g2d.fillOval(200, 60, 10, 10);

		g2d.setColor(Color.BLUE);
		g2d.fillOval(200, 85, 10, 10);
